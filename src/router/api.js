...
export default {
    OAUTH_TOKEN: BASE_PATH + "/love-sports-auth/oauth/token",
    REFRESH_TOKEN: BASE_PATH + "/love-sports-auth/oauth/token",
    USERINFO: BASE_PATH + "/love-sports-auth/auth/userinfo",
    ...
    SYS_USER_INFO_LIST: BASE_PATH + "/love-sports-auth/api/user/list",
    SYS_USER_INFO_SAVE: BASE_PATH + "/love-sports-auth/api/user/save",
    SYS_USER_INFO_UPDATE: BASE_PATH + "/love-sports-auth/api/user/update/",

    CLIENT_LIST: BASE_PATH + "/love-sports-auth/api/client/list",
